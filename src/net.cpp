...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "BitSYNQ " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"seed1", "104.236.198.53"},
	{"seed2", "159.203.20.236"},
	{"seed3", "192.241.248.21"},
	{"seed4", "45.63.0.100"},
	{"seed5", "104.207.152.207"},
	//{"seed6", "xxx.xxx.xxx.xx"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("bitsynq-dnsseed");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. BitSYNQ is probably already running."), addrBind.ToString().c_str());
        else
