...
// Copyright (c) 2014 The BitSYNQ developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("bitsynq-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("bitsynq-smsg-pow"); // Make this thread recognisable
