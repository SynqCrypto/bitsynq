...
const string strMessageMagic = "BitSYNQ Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees, unsigned int nHeight)
{
    ...
    {
        nSubsidy = 21000000 * COIN;   // 20M For CrowdFund and 1M For Bounties & Promotion
    }
	else
	{
		nSubsidy = 0 * COIN;
...
static const int64_t nTargetTimespan = 30 * 60;  // 20 mins
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BitSYNQ", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "BitSYNQ The Decentrailzed P2P Crypto Apps, Services and Games";
        CTransaction txNew;
        txNew.nTime = 1458855999;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1458855999;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1900257;
        if(fTestNet)
        {
            block.nNonce   = 1900257;
        }
        ...
        //// debug print
        ///
        assert(block.hashMerkleRoot == uint256("0xea8e531ef8433f17b7712e85b9a76127568cfbb56e372201ddfc0ce464252e0a"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0x37, 0x1a, 0x22, 0xbd };
